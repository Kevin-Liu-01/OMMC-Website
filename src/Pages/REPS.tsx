          ...
          <div className="flex flex-col md:col-span-4 text-gray-900 dark:text-gray-200 gap-4">
            ...
            <div className="relative">
              ...
              <div className="ml-6 flex gap-4 text-gray-800 lg:items-center dark:text-gray-200 border-2 border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-800 rounded-xl p-4">
                ...
                <div>
                  This spring, OMMC will be hosting the Rutgers Expo in Problem
                  Solving (REPS) event, where we present various speakers in
            ...
            <div className="relative">
              ...
              <div className="ml-6 flex gap-4 text-gray-800 lg:items-center dark:text-gray-200 border-2  border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-800 rounded-xl p-4">
                ...
                <div>
                  Starting in 2023, we will be hosting in-person events in order
                  to reach and motivate people in our local community to become
                  better thinkers, and give them a magical experience with
                  mathematics that they will hopefully remember for a lifetime.
                </div>
              </div>
            </div>
          </div>
