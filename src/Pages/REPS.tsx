            ...
            <div className="col-span-6 relative">
              ...
              <div className="overflow-hidden dark:text-gray-200 border-2 mt-4 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 rounded-xl p-4">
                ...
                <p className="mb-3">
                  ...
                  Please park in parking lots 53, 53A, 60A, or 60B and fill out the <a href="https://parkingbase.com/c/rutgers/d/3676664?eventId=7b7bd40e-9bac-4700-96e7-397ce7b7bd20">Rutgers Parking Permit Form</a>
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <iframe
                    ...
                    src={"/documents/REPS_Itinerary_2.pdf"}
