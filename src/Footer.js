    ...
    <footer class="text-center text-white bg-slate-300">
      <div class=" pt-9">
        <div class="flex justify-center mb-9">
          ...
          <a href="https://twitter.com/officialommc" class="mr-9 text-gray-800">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fab"
          ...
          <a href="mailto:ommcofficial@gmail.com" class="mr-9 text-gray-800">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fab"
          ...
          <a href="https://www.instagram.com/ommcofficial/" class="text-gray-800">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fab"
